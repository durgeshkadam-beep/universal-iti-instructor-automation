...
const files=['v15/v15-auth-roles-v2.js','v15/v15-workspaces-v2.js','v15/v15-governance-v2.js','v15/v15-portals-v2.js','v15/v15-boot-final.js','v15/v15-role-enforcer.js','v15/sw.js'];
let failed=0;
...
const auth=text(files[0]),ws=text(files[1]),gov=text(files[2]),portals=text(files[3]),boot=text(files[4]),enforcer=text(files[5]),rules=text('firestore.rules'),manifest=JSON.parse(text('v15/manifest.json'));
